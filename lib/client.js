				...
				totp.enabled
					? React.createElement('div', null,
						React.createElement('label', null,
							React.createElement('input', { type: 'checkbox', checked: totp.twoFactor, onChange: toggle2fa, disabled: busy, style: { width: 'auto', marginRight: 8 } }),
							'启用两步验证（登录需密码 + 动态码；关闭时密码或动态码任选其一登录）'),
